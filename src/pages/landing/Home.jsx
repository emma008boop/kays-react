...
import MainContainer from '../../components/layout/landing/home/MainContent';
import './Home.css';
...
const Home = () => {
    ...
    return (
            <main className="home-page">
                ...
                />
                <MainContainer videoUrl={savingVideo} tag={tag} text={text} title={title} type='antfocus'></MainContainer>
            </main>
    );
};
